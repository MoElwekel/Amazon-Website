...
class Product{
  ...
  constructor(prouductDetails){
    this.id = prouductDetails.id;
    this.image = prouductDetails.image;
    this.name = prouductDetails.name;
    this.rating =prouductDetails.rating;
...
export function loadProductsFetch(){
  const promise = fetch ('http://supersimplebackend.dev/products').then((response)=>{
    ...
    products = productsData.map((prouductDetails) => {
...
export function loadProducts(fun){
  ...
  xhr.addEventListener('load', () => {
    products = JSON.parse(xhr.response).map((prouductDetails) => {
      if (prouductDetails.type === "clothing") {
        return new Clothing (prouductDetails);
      }
      return new Product (prouductDetails);
